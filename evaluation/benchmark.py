...
class LegalBenchmark:
    ...
    def _generate_retrieval_benchmark(self) -> list[dict]:
        ...
        return [
            ...
            {"query": "Copyright fair use in education", "relevant_citations": ["2016 SCC OnLine Del 3818"]},
            ...
            {"query": "Company director liability in fraud", "relevant_citations": ["(2005) 8 SCC 89"]},
            ...
            {"query": "Foreign judgment enforcement in India", "relevant_citations": ["AIR 1957 SC 604"]},
            ...
            {"query": "Contempt of court for non-compliance", "relevant_citations": ["(1991) 1 SCC 574"]},
